...
print("Simulation time: ", simTime, simEndTime, simStartTime, "seconds")
...
print("Average Delay: ", avgDelay, "seconds")
print("Delivery ratio: ", packetDeliveryRatio)
print("Drop ratio: ", packetDropRatio)
# print(throughput,",",avgDelay,",",packetDeliveryRatio,",",packetDropRatio)


subprocess.call("echo {throughput}, {avgDelay}, {packetDeliveryRatio}, {packetDropRatio} >> {output_file}"
                .format(throughput=throughput, avgDelay=avgDelay, packetDeliveryRatio=packetDeliveryRatio, packetDropRatio=packetDropRatio, output_file=output_file
                        ), shell=True)